...
def resnext50_2x40d(num_classes=1000, include_top=True):
    groups = 2
    width_per_group = 40
...
def resnext50_4x24d(num_classes=1000, include_top=True):
    groups = 4
    width_per_group = 24
    return ResNet(Bottleneck, [3, 4, 6, 3],
                  num_classes=num_classes,
...
def resnext50_8x14d(num_classes=1000, include_top=True):
    groups = 8
    width_per_group = 14
    return ResNet(Bottleneck, [3, 4, 6, 3],
                  num_classes=num_classes,
...
def resnext101_2x40d(num_classes=1000, include_top=True):
    groups = 2
    width_per_group = 40
...
def resnext101_4x24d(num_classes=1000, include_top=True):
    groups = 4
    width_per_group = 24
    return ResNet(Bottleneck, [3, 4, 23, 3],
                  num_classes=num_classes,
...
def resnext101_8x14d(num_classes=1000, include_top=True):
    groups = 8
    width_per_group = 14
    return ResNet(Bottleneck, [3, 4, 23, 3],
                  num_classes=num_classes,
